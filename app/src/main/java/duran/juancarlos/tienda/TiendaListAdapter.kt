...
import duran.juancarlos.tienda.databinding.ListItemTiendaBinding

class TiendaHolder(val binding: ListItemTiendaBinding) : RecyclerView.ViewHolder(binding.root)

class TiendaListAdapter(private val tiendas: List<Tienda1>): RecyclerView.Adapter<TiendaHolder> (){
